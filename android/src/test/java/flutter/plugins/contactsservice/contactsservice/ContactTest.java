...
public class ContactTest {
    ...
    public void compareTo_nullParam() {
        ...
        assertThat(contact1.compareTo(contact2)).isGreaterThan(0);
    }
    ...
    public void compareTo_givenNameNull() {
        ...
        assertThat(contact1.compareTo(contact2)).isEqualTo(0);
    }
    ...
    public void compareTo_nullContact() {
        ...
        assertThat(contact1.compareTo(null)).isGreaterThan(0);
    }
    ...
    public void compareTo_transitiveCompare() {
        ...
        // a > null
        assertThat(contact2.compareTo(contact3)).isGreaterThan(0);

        // This implies => b > null
        assertThat(contact1.compareTo(contact3)).isGreaterThan(0);
    }
}